-- ============================================================
-- opc-erp schema (W72 · opc-erp 9311)
-- 11 表: supplier / product / product_sku / batch /
--        inventory_log / purchase / purchase_item /
--        sale / sale_item / return / daily_snapshot
-- + 5 seed 供应商
-- ============================================================
-- 镜像 V20260912__opc_erp_schema.sql (sql/migrations/), 容器首次启动
-- 会自动跑 (mysql-initdb.d/), 数字前缀确保执行顺序
-- ============================================================
...
-- -----------------------------------------------------------------------------
-- 11) 库存每日快照（Quartz 每日 23:55 落库，供日报/月报查询）
-- -----------------------------------------------------------------------------
