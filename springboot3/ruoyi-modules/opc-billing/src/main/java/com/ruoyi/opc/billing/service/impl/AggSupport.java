...
/**
 * 聚合查询的入参校验与结果归一化助手（M4 INSIGHT Day 2 / Task 2，wallet / order / recharge
 * 三个聚合共用）。
 *
 ...
 *
 * <p>本类是 opc-finance 同名 {@code AggSupport} 的本地副本（任务 7 要求 keep task self-contained，
 * 不抽 opc-common）。两份逻辑保持同步。
 *
 * @author OAC
 */
